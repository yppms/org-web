...
export default function StampSection() {
  ...
  return (
    <div className="p-4 space-y-4 w-full overflow-x-hidden">
      <div>
        <h2 className="text-lg font-bold">Tugas Pesan WhatsApp</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
        ...
        <div className="form-control flex-shrink-0">
          <label className="label cursor-pointer gap-2 justify-start sm:justify-center">
            ...
            />
            <span className="label-text text-sm whitespace-nowrap">Tampilkan terkirim</span>
          </label>
        </div>
      </div>
        ...
        <div className="text-center py-16">
          <p className="text-base-content/60 text-lg">
            {searchTerm
              ...
              : !showSent
              ? 'Semua pesan sudah terkirim! Aktifkan "Tampilkan terkirim" untuk melihatnya.'
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0 self-start sm:self-auto">
                    ...
                    <button
                      ...
                      className="btn btn-sm btn-success gap-1 whitespace-nowrap"
                    >
